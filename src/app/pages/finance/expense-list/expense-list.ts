    ...
    saveExpense(): void {
        ...
        obs.subscribe({
            next: () => {
                ...
                this.messageService.add({ severity: 'success', summary: 'Success', detail: `Expense ${this.isEdit ? 'updated' : 'created'} successfully` });
                this.loadExpenses();
            },
            error: (err) => {
                console.error(err);
                this.saving = false;
                this.messageService.add({ severity: 'error', summary: 'Error', detail: `Failed to ${this.isEdit ? 'update' : 'create'} expense` });
            }
        });
    }
